...
⚠️注意：
- 插件默认为纯rule规则实现，如果需要更智能的升级机制，请在astrbot的插件配置页面，开启llm分析，并将对应的模式切换成hybird或llm
- 在hybird或llm模式下，消息的数量越多，调用次数越多，在插件的配置中推荐使用：按token计费、无思考、最新的、轻量模型
- 为避免行为冲突，建议关闭 AstrBot 自带的“主动回复”和“上下文感知”，以达到更好的效果
- 目前项目正在快速迭代，如遇到问题，请提issue

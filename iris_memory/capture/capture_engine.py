...
class MemoryCaptureEngine:
    ...
    async def _check_duplicate_by_vector(
        ...
        .. deprecated::
            请直接使用 ``self.conflict_resolver.check_duplicate_by_vector()``
        """
        warnings.warn(
            "CaptureEngine._check_duplicate_by_vector is deprecated, "
            "use self.conflict_resolver.check_duplicate_by_vector() directly",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    async def _check_conflicts_by_vector(
        ...
        .. deprecated::
            请直接使用 ``self.conflict_resolver.check_conflicts_by_vector()``
        """
        warnings.warn(
            "CaptureEngine._check_conflicts_by_vector is deprecated, "
            "use self.conflict_resolver.check_conflicts_by_vector() directly",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def _find_duplicate_from_results(
        ...
        .. deprecated::
            请直接使用 ``self.conflict_resolver.find_duplicate_from_results()``
        """
        warnings.warn(
            "CaptureEngine._find_duplicate_from_results is deprecated, "
            "use self.conflict_resolver.find_duplicate_from_results() directly",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def _find_conflicts_from_results(
        ...
        .. deprecated::
            请直接使用 ``self.conflict_resolver.find_conflicts_from_results()``
        """
        warnings.warn(
            "CaptureEngine._find_conflicts_from_results is deprecated, "
            "use self.conflict_resolver.find_conflicts_from_results() directly",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    async def _resolve_conflicts(
        ...
        .. deprecated::
            请直接使用 ``self.conflict_resolver.resolve_conflicts()``
        """
        warnings.warn(
            "CaptureEngine._resolve_conflicts is deprecated, "
            "use self.conflict_resolver.resolve_conflicts() directly",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def _determine_conflict_resolution(
        ...
        .. deprecated::
            请直接使用 ``self.conflict_resolver._determine_conflict_resolution()``
        """
        warnings.warn(
            "CaptureEngine._determine_conflict_resolution is deprecated, "
            "use self.conflict_resolver._determine_conflict_resolution() directly",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    async def check_duplicate(
        ...
        .. deprecated::
            请直接使用 ``self.conflict_resolver.check_duplicate()``
        """
        warnings.warn(
            "CaptureEngine.check_duplicate is deprecated, "
            "use self.conflict_resolver.check_duplicate() directly",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def check_conflicts(
        ...
        .. deprecated::
            请直接使用 ``self.conflict_resolver.check_conflicts()``
        """
        warnings.warn(
            "CaptureEngine.check_conflicts is deprecated, "
            "use self.conflict_resolver.check_conflicts() directly",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def _is_opposite(self, text1: str, text2: str) -> bool:
        ...
        .. deprecated::
            请直接使用 ``self.conflict_resolver.is_opposite()``
        """
        warnings.warn(
            "CaptureEngine._is_opposite is deprecated, "
            "use self.conflict_resolver.is_opposite() directly",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def _calculate_quick_similarity(self, text1: str, text2: str) -> float:
        ...
        .. deprecated::
            请直接使用 ``self.conflict_resolver.similarity_calculator.calculate_quick_similarity()``
        """
        warnings.warn(
            "CaptureEngine._calculate_quick_similarity is deprecated, "
            "use self.conflict_resolver.similarity_calculator.calculate_quick_similarity() directly",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def _calculate_similarity(self, text1: str, text2: str) -> float:
        ...
        .. deprecated::
            请直接使用 ``self.conflict_resolver.similarity_calculator.calculate_similarity()``
        """
        warnings.warn(
            "CaptureEngine._calculate_similarity is deprecated, "
            "use self.conflict_resolver.similarity_calculator.calculate_similarity() directly",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def _longest_common_substring_length(self, s1: str, s2: str) -> int:
        ...
        .. deprecated::
            请直接使用 ``self.conflict_resolver.similarity_calculator._longest_common_substring_length()``
        """
        warnings.warn(
            "CaptureEngine._longest_common_substring_length is deprecated",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def _calculate_content_similarity(self, text1: str, text2: str) -> float:
        ...
        .. deprecated::
            请直接使用 ``self.conflict_resolver.similarity_calculator.calculate_content_similarity()``
        """
        warnings.warn(
            "CaptureEngine._calculate_content_similarity is deprecated",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def _have_common_subject(self, text1: str, text2: str) -> bool:
        ...
        .. deprecated::
            请直接使用 ``self.conflict_resolver.similarity_calculator.have_common_subject()``
        """
        warnings.warn(
            "CaptureEngine._have_common_subject is deprecated",
            DeprecationWarning,
            stacklevel=2,
        )
